...
# Function to generate graph data, 1st: defense_pressure; 2nd: ball-accepting capability; 3rd: speed; 4th: height; 5th: energy
def generate_soccer_graph():
    base_features = torch.tensor([
        [1, 0.9, 0.4, 0.9, 0.9],  # GK
        [1, 0.8, 0.6, 0.85, 0.9], # guard
        [1, 0.8, 0.65, 0.88, 0.88],
        [1, 0.85, 0.75, 0.83, 0.85],
        [1, 0.85, 0.75, 0.83, 0.85],
        [2, 0.95, 0.8, 0.75, 0.8], # midfield
        [2, 0.95, 0.85, 0.7, 0.8], 
        [2, 0.95, 0.85, 0.7, 0.8],
        [3, 0.7, 0.95, 0.65, 0.85], # striker
        [3, 0.7, 0.9, 0.7, 0.85],
        [3, 0.7, 0.9, 0.68, 0.85]
    ], dtype=torch.float)
    ...
    edge_features = []
    edge_labels = []
    # Two edge features: 1. distance 2. chemistry
